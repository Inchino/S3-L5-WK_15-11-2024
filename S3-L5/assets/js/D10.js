...
let random = Math.floor(Math.random() * 21); //21 perchè richiede anche lo 0
//console.log(random);
...
//console.log(splitMe("Prof devo recuperare il quiz"));
...
//console.log(onlyLetters("1 love 4 u"));
...
function howManyDays(date) {
  ...
  let onDateMs = oneDate.getTime();

  let differenceMs = Math.abs(todayMs - onDateMs);
...
const searchByTitle = function (array, string) {
  return array.find((elem) => elem.Title === string);
};
